...
let employees = [
    ...
    { id: 2, name: "Ngọc IOS", phone: "0903238990", image: "Icon-ABBank.webp", used: false },
    ...
    { id: 7, name: "Lê Văn Đức", phone: "0976393238", image: "images/duclv.jpeg", used: false },
    ...
    { id: 11, name: "Hoàng Quốc Việt", phone: "0912353456", image: "images/viethq.png", used: false },
    ...
    { id: 14, name: "Thanh Devops", phone: "0363958716", image: "images/thanhvd.png", used: false },
    { id: 15, name: "Phạm Minh Đức SA", phone: "0378113760", image: "images/ducpm.png", used: false },
    { id: 16, name: "Hưởng Android", phone: "0966323766", image: "Icon-ABBank.webp", used: false },
    ...
    { id: 20, name: "Đậu Vĩnh Yên", phone: "0965533329", image: "images/yendv.png", used: false },
    ...
    { id: 24, name: "Nguyễn Đức Huy (SA)", phone: "0349612486", image: "images/huynd3.png", used: false },
...
let tasks = [
  { "id": 1, "text": "Mời anh Nguyễn Ngọc Thanh 1 chén hoặc tự uống 2 chén" },
  { "id": 2, "text": "Tự uống 2 chén hoặc mời anh Nguyễn Ngọc Thanh 1 chén" },
  { "id": 3, "text": "Chỉ định 1 bạn cùng team uống 2 chén" },
  { "id": 4, "text": "Đồng khởi với 1 bạn tự chỉ định 1 chén hoặc nộp phạt 200k" },
  { "id": 5, "text": "Chỉ định khách mời uống 2 chén" },
  { "id": 6, "text": "Nộp phạt 100k hoặc tự uống 2 chén" },
  { "id": 7, "text": "Hit đất 5 cái hoặc uống 1 chén" },
  { "id": 8, "text": "Tự uống 1 chén rồi chọn người tiếp theo uống 1 chén" },
  { "id": 9, "text": "Chọn 1 team và cùng team đó đồng khởi cộng bắt cái cho team đó rô thật to, không làm được nộp 200k" },
  { "id": 10, "text": "Chỉ định người bên phải uống 2 chén" },
  { "id": 11, "text": "Chỉ định người bên trái uống 2 chén" },
  { "id": 12, "text": "Ôm người bên trái, ôm người bên phải để được thưởng 200k" },
  ...
  { "id": 22, "text": "Oẳn tù tì với người kế bên phải, thua uống 1 chén" },
  { "id": 23, "text": "Không đọc ngược được tên mình thì uống 1 chén" },
  { "id": 24, "text": "Cạch với 1 người bất kỳ và cả hai cùng uống 1 chén" },
  { "id": 25, "text": "Giả giọng nhân vật hoạt hình – không làm được uống 1 chén" },
  { "id": 26, "text": "Chỉ định 1 người nói 3 điều họ ghét – nếu họ không nói: bạn uống 1 chén" },
  { "id": 27, "text": "Không nhớ tên 3 người chơi trong bàn thì uống 1 chén" },
  ...
  { "id": 35, "text": "Uống với VuBX 1 chén hoặc nộp phạt 200k" },
  { "id": 36, "text": "Uống với MinhDT Devops 1 chén hoặc nộp phạt 200k" }
];
