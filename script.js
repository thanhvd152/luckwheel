...
let tasks = [
    ...
    { id: 3, text: "Chỉ định bạn khác cùng team uống đủ 2 chén" },
    { id: 4, text: "Đồng khởi với 1 bạn tự chỉ định 1 chén hoặc nộp 100k" },
    { id: 5, text: "Đồng khởi với 1 bạn chỉ định 1 chén" },
    { id: 6, text: "Chỉ định khách mời uống 3 chén" },
    { id: 7, text: "Nộp 100k hoặc tự uống 3 chén" },
    { id: 8, text: "Trả lời câu đố (không trả lời đúng: phạt)" },
    { id: 9, text: "Kể 1 câu chuyện vui" },
    { id: 10, text: "Nhảy 1 điệu nhảy" },
    { id: 11, text: "Tự uống 1 chén rồi chọn người tiếp theo uống 1 chén" },
    { id: 12, text: "Tất cả người cùng team(BE, IOS, ANDROID, SA, DEVOPS) đồng khởi " },
    { id: 13, text: "Chỉ định người bên phải uống 2 chén" },
    { id: 14, text: "Chỉ định người bên trái uống 2 chén" },
    { id: 15, text: "Chỉ định người bên phải uống 2 chén" },
    { id: 16, text: "Uống 1 chén nếu không làm được chống đẩy 5 cái" },
    { id: 17, text: "Được thưởng 200k" },
    { id: 17, text: "Nhắn tin với người yêu cũ nói muốn quay lại hoặc tự giác uống 2 chén" },
    { id: 17, text: "Được thưởng 200k" },
];
